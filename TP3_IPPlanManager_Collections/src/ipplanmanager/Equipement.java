...
public class Equipement {
    ...
    public void supprimerInterface(String nomInterface) {
        for (int i = 0; i < interfaces.size(); i++) {
            if (interfaces.get(i).getNom().equals(nomInterface)) {
                interfaces.remove(i);
                System.out.println("Interface " + nomInterface + " supprimée");
                return;
            }
        }
        System.out.println("Interface " + nomInterface + " non trouvée");
    }
