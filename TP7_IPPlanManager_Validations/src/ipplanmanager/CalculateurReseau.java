...
public class CalculateurReseau {
    ...
    // Calcul du nombre d'hôtes pour un CIDR donné
    ...
    // Calcul du CIDR minimal pour un nombre d'hôtes
    ...
    // Calcule la première adresse utilisable
    ...
    // Calcule la dernière adresse utilisable
    ...
    // NOUVELLE MÉTHODE: Vérifie si une adresse IP est valide
    ...
    // NOUVELLE MÉTHODE: Vérifie une adresse IP et lève une exception si invalide
    ...
    // NOUVELLE MÉTHODE: Calcule l'adresse de fin d'un réseau
    ...
    // NOUVELLE MÉTHODE: Vérifie si deux réseaux se chevauchent
